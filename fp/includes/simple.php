...
#EDIT THE FOLLOWING:
$toAddress = "lim.chakrya@gmail.com";  //place your/your client's email address here
$toName = "Bun Real"; //place your client's name here
$website = "www.chakryalim.com/web120/fp/index.php";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
if ($response != null && $response->success)
    ...
    <div class="contact-feedback">
        ...
        <p class="thx">Thanks for contacting me.  I'll get back to you within 48 hours. </p>
    </div>    
    <!-- END HTML FEEDBACK -->        
    <?php
...
?>
	...
	<fieldset>
        <legend>Contact Information</legend>
		 ...
		 <label>NAME</label>
        <input type="text" name="Name" required="required" title="Name is required" tabindex="10" size="44" autofocus />
		
        
		 <label> EMAIL</label>
        <input type="email" name="Email" required="required" title="A valid email is required" tabindex="20" size="44" />

        </fieldset><!--contact fieldset-->
	<!-- below change the HTML to your form elements - only 'Name' & 'Email' (above) are significant -->
	<fieldset><!--feedback fieldset-->
        <legend>Comment</legend>
<textarea name="Comments" cols="36" rows="4" tabindex="30"></textarea>
		</fieldset><!--feedback fieldset--> 
